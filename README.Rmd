...
casts between real C++ numbers and strings and their Rccp counterparts. When I figured out the right
ways to do this I'll trash all these scrappy notes and leave pointers to the proper guides. 
